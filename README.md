...
A browser-based collaborative fiction tool. Write scenes with multiple AI characters, each driven by its own independent LLM call with its own filtered context and perspective.

## Model

Designed for use with [Mistral-Small-24B-Instruct-2501](https://huggingface.co/mistralai/Mistral-Small-24B-Instruct-2501) via a local [Jan](https://jan.ai/) server (OpenAI-compatible API). See `mistral-v7-tekken-roleplay-guide.v3.md` for prompt engineering notes specific to this model and setup.
