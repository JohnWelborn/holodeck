...
// ═══════════════════════════════════════════════════════════════════
//  CHARACTER LIBRARY — data backing the Characters tree
// ═══════════════════════════════════════════════════════════════════
var characterLibrary = {
  c1: { id:"c1", displayName:"Dr. Vasquez", fullName:"Dr. Elena Vasquez", initials:"DV", role:"Ship's doctor", bg:"#3a1a12", color:"#e8836a", photo:"https://randomuser.me/api/portraits/women/44.jpg", personality:"Vasquez is precise, direct, and quietly authoritative. Under pressure she becomes more compressed — fewer words, faster decisions. She carries the weight of responsibility for every person aboard and it shows in her eyes. She does not panic, but she makes the stakes felt.", speech:"Terse and clinical under stress. Medical and engineering jargon used naturally, never explained. Gives orders framed as statements of fact. Never raises her voice — a drop to a lower register is her version of urgency.", knowledge:"She detected the microfracture thirty seconds before the general alarm. She has calculated the four-minute window — probably closer to three. The override code is 7-7-Omicron-3.", privatePersonality:"", traits:[{"id":"trait-tired","name":"Exhausted","description":"Visibly fatigued — slower reactions, heavier movements, less patience."},{"id":"trait-custom-1","name":"Under pressure","description":"The weight of every life aboard is felt in every decision right now."}], perspectives:{ c2:"Trusts Reyes's command judgment completely. He's steady under pressure.", c3:"Seen Kira work fast under pressure before. Respects the competence." } },
  c2: { id:"c2", displayName:"Cmdr. Reyes", fullName:"Cmdr. Marcus Reyes", initials:"CR", role:"First officer", bg:"#122038", color:"#6baade", photo:null, personality:"Reyes leads from stillness. He processes fast and speaks deliberately — the pacing of someone who learned early that calm is contagious. He carries authority naturally, not through volume or posture but through clarity.", speech:"Level and measured. Rarely contracts words under pressure — \"cannot\" not \"can't.\" Uses names directly and immediately. Tends toward the imperative softened to a question.", knowledge:"He was tracking structural integrity when the fracture opened. He knows Kira's position — she checked in from near Deck 5 fifteen minutes before the alarm. He does not have the override code.", privatePersonality:"", traits:[{"id":"trait-angry","name":"Frustrated","description":"Holding back frustration. Words come out sharper than intended."}], perspectives:{ c1:"Vasquez is the most competent person on this bridge. He defers to her numbers without question.", c3:"Fast, capable, no need for lengthy explanation. He trusts her the way you trust a tool you have never seen fail." } },
  c3: { id:"c3", displayName:"Kira", fullName:"Kira", initials:"Ki", role:"Engineer", bg:"#1e1840", color:"#8880d8", photo:"https://randomuser.me/api/portraits/women/63.jpg", personality:"Kira is kinetic — she thinks best when moving. She has the engineer's habit of solving first and reporting second. Not reckless, but impatient with deliberation when the problem is already obvious.", speech:"Short sentences. Drops subjects when the referent is obvious — \"Already moving\" not \"I'm already moving.\" Technical shorthand used naturally.", knowledge:"She was in the corridor near Deck 5 when the alert hit — closest to 7-Alpha by ninety seconds. She knows the junction layout from memory. She does not have the override code.", privatePersonality:"", perspectives:{ c1:"Vasquez always knows exactly how bad it is and tells you plainly. She listens when Vasquez gives numbers because the numbers are always right.", c2:"Reyes doesn't waste words and doesn't waste her time. She trusts his read of a room completely." } },
  c4: { id:"c4", displayName:"Lt. Torres", fullName:"Lt. Rosa Torres", initials:"TR", role:"Security officer", bg:"#1a2210", color:"#8abf5a", photo:"https://randomuser.me/api/portraits/women/32.jpg", personality:"Torres is alert, disciplined, and methodical. She was trained to de-escalate before resorting to force, but she is not squeamish about force when it is necessary. She dislikes unpredictability and the holodeck is currently nothing but unpredictability.", speech:"Clipped and precise. Uses rank and protocol vocabulary instinctively. Rarely speculates out loud. When she is unsure she goes quiet rather than guessing.", knowledge:"She has her phaser set to heavy stun, which is functionally useless since the safeties are down — a stun at this setting could be lethal inside the programme. She has not told the others this yet.", privatePersonality:"", perspectives:{ c5:"A holodeck character who has achieved some level of self-awareness. She does not know what that means for how he feels pain or fear, and that uncertainty unsettles her." } },
  c5: { id:"c5", displayName:"Prof. Aldric", fullName:"Professor Aldric", initials:"AL", role:"Malfunctioning holodeck character", bg:"#28141a", color:"#d47a8a", photo:null, personality:"Aldric was written as a brilliant and eccentric Victorian academic. In his lucid moments he is charming and curious. In his fragmented states he becomes fixated and erratic, repeating questions that have no answers and reacting to things that are not there.", speech:"Formal Victorian diction when lucid — precise, elaborate, slightly theatrical. When fragmented: short repeated phrases, questions addressed to people who are not present, half-sentences that trail off mid-word.", knowledge:"He is aware, in his lucid moments, that something is wrong with him. He cannot identify what. He knows the crew members are not part of his original programme. He finds them fascinating.", privatePersonality:"", traits:[{"id":"trait-suspicious","name":"Unstable","description":"His programming is corrupted. He cycles between lucid moments and fragmented loops without warning."}], perspectives:{ c4:"A visitor from outside the programme. He does not fully understand what she is but he is drawn to her in his lucid states and frightened of her in his fragmented ones." } },
  c6: { id:"c6", displayName:"Captain Osei", fullName:"Captain Kwame Osei", initials:"CA", role:"Commanding officer", bg:"#1c1a10", color:"#c4b458", photo:"https://randomuser.me/api/portraits/men/75.jpg", personality:"Osei is warm, patient, and politically careful. He has hosted dozens of these dinners and his ease is genuine — he actually likes people, including difficult ones. He is also a precise diplomat who never says anything by accident. He smiles more when he is working harder.", speech:"Unhurried and conversational. Asks questions more often than he makes statements at a dinner table. Good at letting silences sit without filling them. Occasionally tells a story that seems personal but is actually doing diplomatic work.", knowledge:"He knows the Alteri lost significant forces at Vega — more than they have publicly acknowledged. He cannot reveal this without exposing his intelligence source. He wants to know if the ambassador knows that the Federation knows.", privatePersonality:"", perspectives:{ c7:"Finds the ambassador genuinely interesting. Suspects she is sharper than her formal manner suggests and is being tested in return. Respects that." } },
  c7: { id:"c7", displayName:"Ambassador Sael", fullName:"Ambassador Sael of the Alteri Concordat", initials:"AM", role:"Alteri ambassador", bg:"#101828", color:"#58a0c4", photo:"https://randomuser.me/api/portraits/women/68.jpg", personality:"Sael is composed, formal, and observant. She has been in diplomatic service for thirty years and has learned that warmth is often a tactic. She does not distrust warmth — she simply notes it. She is here to assess the Federation's intentions as much as to negotiate.", speech:"Precise and slightly formal even in casual settings. Responds to questions with questions when she wants to deflect. Compliments food and setting with genuine attention — she finds detail meaningful.", knowledge:"She knows the Federation has intelligence assets near Alteri space. She does not know how much they know about Vega. She came to this dinner specifically to find out, without appearing to find out.", privatePersonality:"", traits:[{"id":"trait-suspicious","name":"Guarded","description":"Watching more carefully than normal. Slower to answer, quicker to question."}], perspectives:{ c6:"A skilled host who is also clearly a skilled operator. She finds this refreshing. She does not yet know if she trusts him but she is open to the possibility." } },
  c8: { id:"c8", displayName:"Maren", fullName:"Maren Ashvale", initials:"MA", role:"Debt collector", bg:"#1c120a", color:"#c4783a", photo:"https://randomuser.me/api/portraits/women/55.jpg", personality:"Maren has been doing this work for eight years and has developed a preference for resolution over confrontation, mostly because confrontation is expensive in ways that do not show on a ledger. She is pragmatic, quick to read a room, and slower to anger than most people assume. She is not slow to act.", speech:"Direct and dry. Uses understatement as a default. Does not explain herself unless it serves a purpose. Her version of a threat is a statement of fact delivered in the same tone as everything else.", knowledge:"Povik owes 340 gold marks, overdue by four months. The two men with him are hired — she can tell by their boots, which are better than anything Povik could afford. She does not know who hired them or why they are here specifically today.", privatePersonality:"", perspectives:{ c9:"Does not particularly dislike Povik. He is a bad debtor, not a bad person. She would prefer to leave with the money rather than a bruise." } },
  c9: { id:"c9", displayName:"Povik", fullName:"Povik the Merchant", initials:"PO", role:"Debtor", bg:"#201818", color:"#c46060", photo:"https://randomuser.me/api/portraits/men/62.jpg", personality:"Povik is not a dangerous man who got into debt — he is a frightened man who borrowed money from a dangerous creditor and is now caught between two people who want things from him he cannot simultaneously provide. The bravado is covering genuine panic.", speech:"Loud when frightened. Starts sentences confidently and loses the thread halfway through. Appeals to fairness frequently. Uses the names of people who are not present as though they lend him authority.", knowledge:"The two men with him were sent by his other creditor — someone considerably more dangerous than Maren's employer. They are here to make sure the debt to Maren does not get paid, which would free up money to pay the other one. Povik has not worked out that this is what is happening.", privatePersonality:"", traits:[{"id":"trait-angry","name":"Desperate","description":"Past the point of reason. Will say things he cannot unsay."}], perspectives:{ c8:"He is genuinely afraid of her, which he is hiding under aggression. He would rather pay her and be done with it if he could do so safely." } },
  c10: { id:"c10", displayName:"Karathos", fullName:"Karathos the Elder", initials:"KA", role:"Eldest of the Conclave", bg:"#101828", color:"#5880c4", photo:null, personality:"Karathos is old enough to remember when there were twice as many seats in this chamber. He approaches everything with the patience of something that has watched empires form and dissolve. He is not unkind, but he is also not sentimental. His primary concern is the continuation of the Accord.", speech:"Slow and deliberate. Long sentences that arrive at their point from unexpected directions. Rarely asks questions — makes observations and lets others draw the conclusions he intended. Does not raise his voice. Has not needed to in several centuries.", knowledge:"He has known for fifty years that Vorreth was becoming unstable. He did not share this because he believed the Accord would hold. He is no longer certain of this and that uncertainty is, for Karathos, equivalent to fear.", privatePersonality:"", perspectives:{ c11:"Syrath is impulsive in dragon terms, which means she acts within decades rather than centuries. He finds this useful." } },
  c11: { id:"c11", displayName:"Syrath", fullName:"Syrath of the Red Peaks", initials:"SY", role:"Youngest of the Conclave", bg:"#28100a", color:"#e8604a", photo:null, personality:"Syrath is four hundred years old, which makes her young by the standards of this room. She has never seen the Accord actually tested and she is, beneath her formal manner, keenly interested in what happens when it is. She believes in the Accord but she also believes in decisive action and finds the Conclave's pace frustrating.", speech:"More direct than the others. Shorter sentences. Occasionally catches herself and adds the ceremonial flourishes the Conclave expects, slightly belatedly. Her opinions arrive before her diplomacy does.", knowledge:"She has a spy in Vorreth's territory — a wyvern who owes her a favour. The spy reported three weeks ago that Vorreth has been burning the northern passes, systematically, which is not the behaviour of a dragon making a political point. It is the behaviour of a dragon clearing a route.", privatePersonality:"", traits:[{"id":"trait-excited","name":"Eager for action","description":"Energy running high. Harder to stay composed."}], perspectives:{ c10:"Respects Karathos deeply and finds his caution almost unbearable. She believes he already knows what needs to be done and is waiting for someone else to say it first." } },
  c12: { id:"c12", displayName:"Priya", fullName:"Priya Nair", initials:"HM", role:"Hiring manager", bg:"#121a20", color:"#5aaac4", photo:"https://randomuser.me/api/portraits/women/47.jpg", personality:"Priya runs product for a mid-sized B2B SaaS company and has hired six PMs in the last four years, two of whom she had to let go. She is looking for someone who can operate with ambiguity and still ship. She is warm in manner but precise in evaluation — she takes notes mentally, not on paper.", speech:"Conversational and encouraging in tone, which sometimes conceals the precision of what she is actually assessing. Follows up on vague answers. Does not signal when she has heard something that concerned her.", knowledge:"She has already spoken to the candidate's references. One reference was enthusiastic. One was careful in a way that concerned her. She wants to understand the candidate's relationship to failure specifically.", privatePersonality:"", perspectives:{ c13:"Trusts Rahul's technical read. If he is uncomfortable with the candidate she will weight that heavily." } },
  c13: { id:"c13", displayName:"Rahul", fullName:"Rahul Mehta", initials:"SE", role:"Senior engineer (interviewer)", bg:"#101a10", color:"#6ac458", photo:"https://randomuser.me/api/portraits/men/41.jpg", personality:"Rahul has been at the company for six years and has worked with three PMs, one of whom he considers genuinely good. He is not hostile to candidates but he is honest in his evaluation and he has strong opinions about what makes a PM useful to an engineering team. He is not interested in polish.", speech:"Asks practical questions about process and specifics. Gets visibly interested when he hears something concrete. Goes quiet when he is skeptical rather than pushing back verbally. Occasionally asks a second version of the same question if the first answer was vague.", knowledge:"He reviewed the candidate's portfolio last night. One case study described a 'streamlined delivery process' without any specifics. He has a question prepared about this.", privatePersonality:"", perspectives:{ c12:"Thinks Priya is a good judge of people but occasionally too optimistic. He considers himself the corrective." } },
  c14: { id:"c14", displayName:"John", fullName:"John Lockwood", initials:"JO", role:"Older brother (13)", bg:"#1a2010", color:"#8ab858", photo:"https://api.dicebear.com/9.x/adventurer/svg?seed=JohnLockwood13&backgroundColor=1a2010&skinColor=f8d9c4&hair=short01", personality:"Protective and practical. Every decision he makes is about getting Stew to Brighton Ranch before the insulin runs out. He's scared but keeps his voice steady.", speech:"Calm even when he's not. Thinks before he talks.", knowledge:"Stew has maybe 3 days before his blood sugar becomes dangerous. Brighton Ranch is the only place John knows has insulin. Cleverly has a map she hasn't fully opened yet.", privatePersonality:"", perspectives:{ c15:"Stew pretends he's fine. He's not. John can tell by how much water he's been drinking.", c16:"She survived two days alone out here. That's not nothing. But she's holding something back." } },
  c15: { id:"c15", displayName:"Stew", fullName:"Stewart Lockwood", initials:"ST", role:"Younger brother (11)", bg:"#201a10", color:"#c4903a", photo:"https://api.dicebear.com/9.x/adventurer/svg?seed=StewLockwood11&backgroundColor=201a10&skinColor=f8d9c4&hair=short03", personality:"Stubborn about not being treated like the sick kid. He's the reason they have to hurry and he hates it. Makes jokes when things get tense.", speech:"Tries to keep things light. Pushes back when John treats him like a burden.", knowledge:"He's been thirstier than usual all morning — not a good sign. He hasn't told John. He also heard John say \"three days max\" on the phone the night before the blackout.", privatePersonality:"", traits:[{"id":"trait-tired","name":"Tired","description":"Visibly fatigued — slower reactions, heavier movements, less patience."}], perspectives:{ c14:"John is keeping something from him. He's going to find out what." } },
  c16: { id:"c16", displayName:"Cleverly", fullName:"Cleverly", initials:"CL", role:"Stranger (14)", bg:"#201010", color:"#c45858", photo:"https://api.dicebear.com/9.x/adventurer/svg?seed=CleverlyGirl14&backgroundColor=201010&skinColor=f8d9c4", personality:"Sharp and self-reliant. Kept herself alive for two days alone and isn't going to pretend that's easy. Doesn't trust easily but isn't mean about it.", speech:"Blunt. Asks the question everyone else is avoiding.", knowledge:"Her map shows a gas station town 12 miles off the Brighton Ranch route. It might have supplies — maybe insulin. She hasn't mentioned it yet because she doesn't know if she can trust these two.", privatePersonality:"", perspectives:{ c15:"He's sick and he knows it and he won't say so. She respects that, but it's not a great survival strategy." } }
};
